...
// Mesages options
m_OUT_OF_RESOURECES_MESSAGES(0),
m_STUDENDS_MESSAGES(0),
m_CONSTRUCTION_MESSAGES(0),
m_GOLD_BY_ENTERTAINMEN_MESSAGES(0),
m_CITY_GROWTH_MESSAGES(0),
m_ALMOST_NO_RAW_MESSAGES(0),
// Funding farther upkeep
m_FUNDING_FARTHER_UPKEEP_START(0),
m_FUNDING_FARTHER_UPKEEP_END(0),
m_FUNDING_FARTHER_UPKEEP_EXPLORATION_FACTOR(0),
m_FUNDING_FARTHER_UPKEEP_RELIGION_FACTOR(0),
m_FUNDING_FARTHER_UPKEEP_TREADE_FACTOR(0),
m_FUNDING_FARTHER_UPKEEP_MILITARY_FACTOR(0),
m_FUNDING_FARTHER_UPKEEP_POLITICS_FACTOR(0),
// Wild Animals
...
void CvGlobals::cacheGlobals()
{
	...
	// Mesages options
	m_OUT_OF_RESOURECES_MESSAGES = getDefineINT("OUT_OF_RESOURECES_MESSAGES");
	m_STUDENDS_MESSAGES = getDefineINT("STUDENDS_MESSAGES");
	m_CONSTRUCTION_MESSAGES = getDefineINT("CONSTRUCTION_MESSAGES");
	m_GOLD_BY_ENTERTAINMEN_MESSAGES = getDefineINT("GOLD_BY_ENTERTAINMEN_MESSAGES");
	m_CITY_GROWTH_MESSAGES = getDefineINT("CITY_GROWTH_MESSAGES");
	m_ALMOST_NO_RAW_MESSAGES = getDefineINT("ALMOST_NO_RAW_MESSAGES");
	// Funding farther upkeep
	m_FUNDING_FARTHER_UPKEEP_START = getDefineFLOAT("FUNDING_FARTHER_UPKEEP_START");
	m_FUNDING_FARTHER_UPKEEP_END = getDefineFLOAT("FUNDING_FARTHER_UPKEEP_END");
	m_FUNDING_FARTHER_UPKEEP_EXPLORATION_FACTOR = getDefineFLOAT("FUNDING_FARTHER_UPKEEP_EXPLORATION_FACTOR");
	m_FUNDING_FARTHER_UPKEEP_RELIGION_FACTOR = getDefineFLOAT("FUNDING_FARTHER_UPKEEP_RELIGION_FACTOR");
	m_FUNDING_FARTHER_UPKEEP_TREADE_FACTOR = getDefineFLOAT("FUNDING_FARTHER_UPKEEP_TREADE_FACTOR");
	m_FUNDING_FARTHER_UPKEEP_MILITARY_FACTOR = getDefineFLOAT("FUNDING_FARTHER_UPKEEP_MILITARY_FACTOR");
	m_FUNDING_FARTHER_UPKEEP_POLITICS_FACTOR = getDefineFLOAT("FUNDING_FARTHER_UPKEEP_POLITICS_FACTOR");
	// Wild Animals
