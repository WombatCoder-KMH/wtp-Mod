...
public:
	...
	float getFUNDING_FARTHER_UPKEEP_START();
	float getFUNDING_FARTHER_UPKEEP_END();
	float getFUNDING_FARTHER_UPKEEP_EXPLORATION_FACTOR();
	float getFUNDING_FARTHER_UPKEEP_RELIGION_FACTOR();
	float getFUNDING_FARTHER_UPKEEP_TREADE_FACTOR();
	float getFUNDING_FARTHER_UPKEEP_MILITARY_FACTOR();
	float getFUNDING_FARTHER_UPKEEP_POLITICS_FACTOR();
	// Wild Animals
...
protected:
	...
	************************************************************************************************************************/
	...
	// Funding farther upkeep
	float m_FUNDING_FARTHER_UPKEEP_START;
	float m_FUNDING_FARTHER_UPKEEP_END;
	float m_FUNDING_FARTHER_UPKEEP_EXPLORATION_FACTOR;
	float m_FUNDING_FARTHER_UPKEEP_RELIGION_FACTOR;
	float m_FUNDING_FARTHER_UPKEEP_TREADE_FACTOR;
	float m_FUNDING_FARTHER_UPKEEP_MILITARY_FACTOR;
	float m_FUNDING_FARTHER_UPKEEP_POLITICS_FACTOR;
	// Wild Animals
...
// Funding farther upkeep
inline float CvGlobals::getFUNDING_FARTHER_UPKEEP_START()
{
	return m_FUNDING_FARTHER_UPKEEP_START;
}
inline float CvGlobals::getFUNDING_FARTHER_UPKEEP_END()
{
	return m_FUNDING_FARTHER_UPKEEP_END;
}
inline float CvGlobals::getFUNDING_FARTHER_UPKEEP_EXPLORATION_FACTOR()
{
	return m_FUNDING_FARTHER_UPKEEP_EXPLORATION_FACTOR;
}
inline float CvGlobals::getFUNDING_FARTHER_UPKEEP_RELIGION_FACTOR()
{
	return m_FUNDING_FARTHER_UPKEEP_RELIGION_FACTOR;
}
inline float CvGlobals::getFUNDING_FARTHER_UPKEEP_TREADE_FACTOR()
{
	return m_FUNDING_FARTHER_UPKEEP_TREADE_FACTOR;
}
inline float CvGlobals::getFUNDING_FARTHER_UPKEEP_MILITARY_FACTOR()
{
	return m_FUNDING_FARTHER_UPKEEP_MILITARY_FACTOR;
}
inline float CvGlobals::getFUNDING_FARTHER_UPKEEP_POLITICS_FACTOR()
{
	return m_FUNDING_FARTHER_UPKEEP_POLITICS_FACTOR;
}
